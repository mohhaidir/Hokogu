        ...
        <div className={classes.paper}>
          ...
          <form className={classes.form} noValidate>
            ...
            <Grid style={{marginTop: '30px'}}container>
              ...
              <Link onClick={props.handleClose} style={{textDecoration: "none"}} to='/register'>
                <p style={{ color: '#FF5F6D', fontSize: '17px', textDecoration: 'underline'}} >Don't have an account? Sign Up</p>
              </Link>
